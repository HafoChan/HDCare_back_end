...
import com.doctorcare.PD_project.respository.OnboardUserClient;
import com.doctorcare.PD_project.respository.OutboundClient;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) throws AppException {
        ...
        if (!user.isEnable() ) {
            applicationEventPublisher.publishEvent(new OnRegisterEvent(user, "https://hdcarebackend-production.up.railway.app/v1/patient", Locale.ENGLISH));
